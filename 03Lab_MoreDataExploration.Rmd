...
```{r DataExercise-1a}
high_temp <-c(83,83,84,78,71,79,82,85,84,82)
low_temp <-c(86,58,60,61,63,63,64,64,63,60)
```
...
low_temp_c <-(low_temp-32)*5/9
```

Combine your four vectors into a data frame and add informative column names.

```{r DataExercise-1c}
df.temp <-data.frame(high_temp,low_temp,high_temp_C,low_temp_c)
```
...
date_juneteenth <-day(str_juneteenth)
date_juneteenth
#format(today, format = "")
