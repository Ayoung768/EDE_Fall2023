...
#2 Identify the dimensions, column names, and structure of each dataset
...
```{r}
#3 Change the Date columns to date object
# Ozone,NC, 2018
class(Ozone.NC.2018$Date)
Ozone.NC.2018$Date<-as.Date(Ozone.NC.2018$Date,format="%M-%d-%Y")
class(Ozone.NC.2018$Date)

# Ozone, NC, 2019
Ozone.NC.2019$Date<-as.Date(Ozone.NC.2019$Date,format="%M-%d-%Y")
...
#5 Mutate (Used 'mutate' function to fill all cells in AQS_PARAMETER_DESC column to "PM 2.5"
