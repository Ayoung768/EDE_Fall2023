...
#I intalled two pacakges, tidyverse and lubridate, and imported two datasets from the raw data folder.  
```
...
> Answer: Because using neonicotinoids is having a negative impacts on ecological system, especially pollinators and water(aquatic) ecosystem. 
#From Xerces Society 
...
```{r}
#Dimension of Neonics (4623 Rows, 30 Columns)
dim(Neonics)

#Dimension of Litter(188 Rows, 19 Columns)
dim(Litter)
...
> Answer:The most common effects that are studied is Population with 1803. Population would be of interest 
...
```{r} 
#Frequency Line Graph with Publication Year
...
> Answer: The most common test locations 
...
```{r} 
#Determine the class of collectDate (Factor)
